...
%% Colors for text
%\definecolor{darkred}{HTML}{ad1414}
...
\name{}{Shubham Mathur}
%\address{}
\mobile{(+91) 9443129941}
%%% Social
\email{shubham.mathur@engineer.com}
\homepage{https://shubhammathur.me/} 
\github{googleknight}
\linkedin{googleknight}
%%% Optionals
